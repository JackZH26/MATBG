...
The author acknowledges use of open-source scientific computing tools including NumPy, SciPy, and Matplotlib. Band velocities and Berry connections were computed using central finite-difference derivatives with step size $\delta k = 10^{-6}$~\AA$^{-1}$.
\end{acknowledgments}
