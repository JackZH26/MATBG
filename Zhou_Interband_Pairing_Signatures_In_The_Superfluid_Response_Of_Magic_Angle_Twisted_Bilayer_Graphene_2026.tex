...
superfluid-weight table and show that the prior benchmark can be only partially
reconstructed from a unified convention.
...
Recent dielectric-environment measurements and strong-correlation modeling
further emphasize that the microscopic pairing mechanism in twisted bilayer
graphene is not yet settled~\cite{gao_interactions_2026,liang_gutzwiller_2026}.
