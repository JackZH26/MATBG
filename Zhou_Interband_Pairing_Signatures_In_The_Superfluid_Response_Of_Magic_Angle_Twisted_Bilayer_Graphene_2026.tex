...
\begin{abstract}
The anomalously large superfluid response of magic-angle twisted bilayer
graphene is often discussed in terms of quantum geometry, but the extent to
which the orbital structure of the superconducting gap leaves a separable
response signature remains less directly quantified.
We address this question with an executable
Bistritzer-MacDonald--Bogoliubov-de Gennes workflow that tests
orbital-projected interband-pairing directions in a finite-band response
calculation.
...
valley convention, allowing the pairing direction and response convention to
